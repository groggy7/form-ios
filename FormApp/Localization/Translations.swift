...
public enum Translations {
    public static let en: [String: String] = [
        ...
        "matrix.subtitle": "Weekly hypertrophy landmarks & recovery",
        "matrix.mode.completed": "Logged Volume",
        "matrix.mode.planned": "Planned Routine",
        "matrix.thisWeek": "This Week",
        "matrix.previousWeek": "Previous Week",
        "matrix.nextWeek": "Next Week",
        "matrix.stat.totalSets": "Total Sets",
        "matrix.stat.optimal": "Optimal",
        "matrix.stat.undertrained": "Undertrained",
        "matrix.stat.highFatigue": "High Fatigue",
        ...
        "matrix.zone.under_mev": "Under MEV",
        "matrix.zone.under_mev_desc": "Below minimum effective volume. Maintenance only.",
        "matrix.zone.progressive": "Progressive",
        "matrix.zone.progressive_desc": "Effective stimulation for progressive adaptation.",
        "matrix.zone.optimal_mav": "Optimal MAV",
        "matrix.zone.optimal_mav_desc": "Maximum adaptive volume — the hypertrophy sweet spot.",
        "matrix.zone.high_fatigue": "High Fatigue",
        "matrix.zone.high_fatigue_desc": "Approaching recovery capacity. Consider deloading soon.",
        "matrix.zone.over_mrv": "Over MRV",
        "matrix.zone.over_mrv_desc": "Exceeds recoverable volume. High risk of overtraining.",
        "pro.volume_matrix.title": "Biomechanical Volume Matrix",
        "pro.volume_matrix.description": "Track direct and indirect working sets against scientific MEV, MAV, and MRV landmarks with an interactive anatomical heatmap.",
        ...
        "pro.form_lab.title": "Form Lab Analytics",
        "pro.form_lab.description": "Multi-rep max curves, antagonist muscular balance, and encrypted cloud mirror.",
        "pro.upgrade_cta": "Unlock FORM Pro",
    ...
    public static let tr: [String: String] = [
        ...
        "matrix.subtitle": "Haftalık hipertrofi hedefleri ve toparlanma",
        "matrix.mode.completed": "Kayıtlı Hacim",
        "matrix.mode.planned": "Planlanan Program",
        "matrix.thisWeek": "Bu Hafta",
        "matrix.previousWeek": "Önceki Hafta",
        "matrix.nextWeek": "Sonraki Hafta",
        "matrix.stat.totalSets": "Toplam Set",
        "matrix.stat.optimal": "Optimal",
        "matrix.stat.undertrained": "Yetersiz",
        "matrix.stat.highFatigue": "Yüksek Yorgunluk",
        ...
        "matrix.setsUnit": "set",
        "matrix.zone.under_mev": "MEV Altı",
        "matrix.zone.under_mev_desc": "Minimum etkili hacmin altında. Yalnızca koruma sağlar.",
        "matrix.zone.progressive": "İlerleyici",
        "matrix.zone.progressive_desc": "Gelişim sağlayan etkili antrenman uyarısı.",
        "matrix.zone.optimal_mav": "Optimal MAV",
        "matrix.zone.optimal_mav_desc": "Maksimum uyum hacmi — en verimli kas geliştirme aralığı.",
        "matrix.zone.high_fatigue": "Yüksek Yorgunluk",
        "matrix.zone.high_fatigue_desc": "Toparlanma sınırına yaklaşıyor. Yakında deload düşünün.",
        "matrix.zone.over_mrv": "MRV Üstü",
        "matrix.zone.over_mrv_desc": "Toparlanabilir hacmi aşıyor. Sürantrene olma riski yüksek.",
        "pro.volume_matrix.title": "Biyomekanik Hacim Matrisi",
        "pro.volume_matrix.description": "Doğrudan ve dolaylı çalışma setlerini MEV, MAV ve MRV hedeflerine göre etkileşimli anatomik ısı haritasıyla takip edin.",
        ...
        "pro.form_lab.title": "Form Lab Analitiği",
        "pro.form_lab.description": "Çoklu tekrar maksimum eğrileri, kas denge analizleri ve şifreli bulut yedekleme.",
        "pro.upgrade_cta": "FORM Pro'ya Geç",
