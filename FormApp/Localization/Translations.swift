...
public enum Translations {
    public static let en: [String: String] = [
        ...
        "modal.exercise.videosSub": "Up to 3 YouTube video or Shorts links, one per line",
    ...
    public static let tr: [String: String] = [
        ...
        "modal.exercise.videosSub": "En fazla 3 YouTube videosu veya Shorts bağlantısı, her satıra bir tane",
