...
public enum Translations {
    public static let en: [String: String] = [
        ...
        "pro.return_calendar": "Return to Calendar",
        ...
        "form_lab.rep_max_matrix_title": "Multi-Rep Max Matrix",
        "form_lab.rep_max_matrix_subtitle": "Estimated maximal loads based on your historic performance",
        "form_lab.achieved_with": "Best: {weight} × {reps} on {date}",
        "form_lab.no_weighted_sets": "No weighted sets recorded for this exercise yet.",
        "form_lab.timeframe.3m": "3M",
        "form_lab.timeframe.6m": "6M",
        "form_lab.timeframe.1y": "1Y",
        "form_lab.timeframe.all": "ALL",
        "form_lab.curves_title": "Longitudinal Strength Curves",
        "form_lab.curves_subtitle": "Interactive trajectory of peak estimated 1RM over time",
        "form_lab.start_1rm": "Start 1RM",
        "form_lab.current_1rm": "Current 1RM",
        "form_lab.peak_1rm": "All-Time Peak",
        "form_lab.net_gain": "Net Progress",
        ...
        "form_lab.info_brzycki_epley_desc": "Brzycki (1RM = w × 36 / (37 - r)) is the exercise science standard for repetitions under 10. Epley (1RM = w × (1 + r / 30)) provides high accuracy across moderate-to-high rep sets.",
    ...
    public static let tr: [String: String] = [
        ...
        "pro.return_calendar": "Takvime Dön",
        "paywall.badge": "FORCED REP PRO",
        ...
        "form_lab.rep_max_matrix_title": "Çoklu Tekrar Maksimum Matrisi",
        "form_lab.rep_max_matrix_subtitle": "Geçmiş performansınıza dayalı tahmini maksimum kaldırma kapasiteleri",
        "form_lab.achieved_with": "En İyi: {date} tarihinde {weight} × {reps}",
        "form_lab.no_weighted_sets": "Bu egzersiz için henüz ağırlıklı set kaydedilmedi.",
        "form_lab.timeframe.3m": "3 AY",
        "form_lab.timeframe.6m": "6 AY",
        "form_lab.timeframe.1y": "1 YIL",
        "form_lab.timeframe.all": "TÜMÜ",
        "form_lab.curves_title": "Boylamsal Güç Eğrileri",
        "form_lab.curves_subtitle": "Zaman içindeki zirve tahmini 1RM gelişim eğriniz",
        "form_lab.start_1rm": "Başlangıç 1RM",
        "form_lab.current_1rm": "Güncel 1RM",
        "form_lab.peak_1rm": "Tüm Zamanlar Zirvesi",
        "form_lab.net_gain": "Net Gelişim",
        ...
        "form_lab.info_brzycki_epley_desc": "Brzycki (1RM = w × 36 / (37 - r)) 10 tekrarın altındaki setlerde egzersiz biliminin altın standardıdır. Epley (1RM = w × (1 + r / 30)) orta ve yüksek tekrar aralıklarında yüksek doğruluk sağlar.",
