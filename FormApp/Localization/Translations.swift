...
public enum Translations {
    public static let en: [String: String] = [
        ...
        "progression.info.plateauText": "If performance stalls across 3 consecutive sessions, muscle adaptation has slowed and fatigue has outpaced recovery. FORM recommends taking a 1-week recovery deload (-10% load, 2 sets) or swapping to a biomechanically equivalent variation.",
    ...
    public static let tr: [String: String] = [
        ...
        "progression.info.plateauText": "Ağırlık ve tekrar 3 antrenman boyunca ilerlemezse, kas adaptasyonu yavaşlamış ve yorgunluk toparlanmayı aşmış demektir. FORM, 1 haftalık toparlanma deloadı veya biyomekanik olarak eşdeğer bir varyasyon önerir.",
