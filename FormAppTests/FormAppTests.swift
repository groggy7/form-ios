...
final class FormAppTests: XCTestCase {
    ...
    func testMovementSpritesResolution() {
        ...
        XCTAssertEqual(hammerCurlSprite?.imageName, "anatomy_batch_04_upper")
        XCTAssertEqual(hammerCurlSprite?.top, 783)
        XCTAssertEqual(hammerCurlSprite?.bottom, 1254)
        XCTAssertEqual(hammerCurlSprite?.atlasHeight, 1254)

        let dumbbellRdlSprite = MovementIcon.movementAssetSprite("dumbbell-romanian-deadlift")
        XCTAssertEqual(dumbbellRdlSprite?.imageName, "anatomy_batch_04_lower")
        XCTAssertEqual(dumbbellRdlSprite?.top, 806)
        XCTAssertEqual(dumbbellRdlSprite?.bottom, 1254)
        XCTAssertEqual(dumbbellRdlSprite?.atlasHeight, 1254)

        let trapBarDeadliftSprite = MovementIcon.movementAssetSprite("trap-bar-deadlift")
        XCTAssertEqual(trapBarDeadliftSprite?.imageName, "anatomy_batch_01_lower")
        XCTAssertEqual(trapBarDeadliftSprite?.top, 419)
        XCTAssertEqual(trapBarDeadliftSprite?.bottom, 821)
        XCTAssertEqual(trapBarDeadliftSprite?.atlasHeight, 1254)
