...
public enum Translations {
    public static let en: [String: String] = [
        ...
        "paywall.volume_matrix.benefit1": "MEV, MAV & MRV Hypertrophy Landmarks",
        "paywall.volume_matrix.benefit1_desc": "Track direct and indirect sets against scientific volume thresholds per muscle group.",
        ...
        "paywall.volume_matrix.benefit3": "Systemic Fatigue Optimization",
        "paywall.volume_matrix.benefit3_desc": "Plan your recovery cycles with weekly volume balance to eliminate overtraining.",
    ...
    public static let tr: [String: String] = [
        ...
        "paywall.volume_matrix.benefit1": "MEV, MAV ve MRV Hipertrofi Hedefleri",
        "paywall.volume_matrix.benefit1_desc": "Her kas grubu için doğrudan ve dolaylı setleri bilimsel hacim eşiklerine göre takip edin.",
        ...
        "paywall.volume_matrix.benefit3": "Sistemik Yorgunluk Optimizasyonu",
        "paywall.volume_matrix.benefit3_desc": "Aşırı antrenman riskini önlemek için toparlanma döngülerinizi haftalık hacimle dengeleyin.",
