...
public enum Translations {
    public static let en: [String: String] = [
        ...
        "matrix.info.title": "Volume & Recovery Guide",
        "matrix.info.overviewTitle": "What This Matrix Shows",
        "matrix.info.overviewText": "Tracks weekly volume across 13 canonical muscle groups using scientific volume landmarks from Renaissance Periodization (RP). It guides you to optimal hypertrophy without accumulating excessive fatigue.",
        "matrix.info.calculationTitle": "How Volume is Counted",
        "matrix.info.directSetsTitle": "Direct Sets (1.0×)",
        "matrix.info.directSetsDesc": "Primary mover exercises receive full volume credit (e.g., Bench Press counts as 1.0× set for Chest).",
        "matrix.info.indirectSetsTitle": "Indirect Sets (0.5×)",
        "matrix.info.indirectSetsDesc": "Synergist muscles that contribute significantly receive half volume credit (e.g., Bench Press counts as 0.5× set for Triceps and Front Shoulders).",
        "matrix.info.zonesTitle": "Volume & Recovery Zones",
        "matrix.info.zonesSubtitle": "Scientific thresholds for progressive muscle hypertrophy",
        ...
        "matrix.info.zoneUnderMevDetail": "Below Minimum Effective Volume. Stimulus is only enough to maintain existing muscle, not to trigger noticeable growth.",
        "matrix.info.zoneProgressiveDetail": "Progressive Overload Zone. Triggers muscle protein synthesis and steady gains with low fatigue accumulation.",
        "matrix.info.zoneOptimalMavDetail": "Maximum Adaptive Volume — The Sweet Spot. The volume range delivering the greatest muscle growth rate per unit of fatigue.",
        "matrix.info.zoneHighFatigueDetail": "High Fatigue Accumulation. Produces hypertrophy but rapidly builds systemic and joint fatigue. Best used late in a mesocycle before deloading.",
        "matrix.info.zoneOverMrvDetail": "Exceeds Maximum Recoverable Volume. Fatigue exceeds your ability to recover, resulting in performance decline, elevated injury risk, and wasted 'junk volume'.",
        "matrix.info.tipTitle": "Training Tip",
        "matrix.info.tipText": "Aim to keep target muscles in the Progressive or Optimal MAV zones throughout your mesocycle, and schedule a deload week when multiple muscles reach High Fatigue or Over MRV.",
        ...
        "pro.form_lab.description": "Multi-rep max matrix, longitudinal strength curves, antagonist balance ratios, and encrypted private cloud mirror.",
        ...
        "form_lab.tab_balance": "Structural Balance",
        ...
        "form_lab.balance_title": "Antagonist & Structural Balance",
        "form_lab.balance_subtitle": "Biomechanical ratios across opposing muscle groups to prevent joint impingement and postural rounding",
        "form_lab.balance.optimal": "OPTIMAL BALANCE",
        "form_lab.balance.primary_dominant": "PRIMARY HEAVY",
        "form_lab.balance.antagonist_dominant": "ANTAGONIST HEAVY",
        "form_lab.balance.insufficient_data": "MORE DATA NEEDED",
        "form_lab.balance.push_pull_title": "Push vs. Pull (Shoulder & Scapula)",
        "form_lab.balance.push_label": "Push",
        "form_lab.balance.pull_label": "Pull",
        "form_lab.balance.push_dominant_alert": "Push Dominant: Elevated anterior shoulder tension and internal rotation risk.",
        "form_lab.balance.pull_dominant_alert": "Pull Dominant: Posterior upper volume emphasis.",
        "form_lab.balance.push_pull_optimal": "Balanced glenohumeral stability and scapular retraction.",
        "form_lab.balance.push_dominant_rec": "Recommendation: Add Face Pulls, Chest-Supported Rows, or Rear Delt Flies to protect shoulders.",
        "form_lab.balance.pull_dominant_rec": "Recommendation: Balance with overhead or horizontal pressing variations.",
        "form_lab.balance.push_pull_optimal_rec": "Great structural symmetry. Continue balanced programming.",
        "form_lab.balance.quad_ham_title": "Quad vs. Hamstring (Knee & ACL)",
        "form_lab.balance.quad_label": "Quads",
        "form_lab.balance.ham_label": "Hamstrings",
        "form_lab.balance.quad_dominant_alert": "Quad Dominant: Elevated anterior knee shear force and patellofemoral load.",
        "form_lab.balance.ham_dominant_alert": "Hamstring Dominant: High posterior chain bias.",
        "form_lab.balance.quad_ham_optimal": "Balanced knee flexion and extension torque forces.",
        "form_lab.balance.quad_dominant_rec": "Recommendation: Add Romanian Deadlifts, Leg Curls, or Hip Thrusts.",
        "form_lab.balance.ham_dominant_rec": "Recommendation: Balance with Squats or Quad Extensions.",
        "form_lab.balance.quad_ham_optimal_rec": "Optimal knee flexion-to-extension equilibrium.",
        "form_lab.balance.upper_lower_title": "Upper vs. Lower Body (Systemic)",
        "form_lab.balance.upper_label": "Upper Body",
        "form_lab.balance.lower_label": "Lower Body",
        "form_lab.balance.upper_dominant_alert": "Upper Body Heavy: Consider dedicating more volume to lower body stability.",
        "form_lab.balance.lower_dominant_alert": "Lower Body Heavy: Leg-dominant split.",
        "form_lab.balance.upper_lower_optimal": "Well-distributed whole-body stimulus.",
        "form_lab.balance.upper_dominant_rec": "Recommendation: Increase weekly leg training frequency.",
        "form_lab.balance.lower_dominant_rec": "Recommendation: Add upper body compound sets.",
        "form_lab.balance.upper_lower_optimal_rec": "Systemic training distribution is well-proportioned.",
        "form_lab.balance.more_data_needed": "Log at least 3 working sets in each pairing to unlock balance diagnostics.",
        "form_lab.balance.log_more_workouts": "Log more workouts to calculate structural ratio.",
        ...
        "form_lab.info_title": "Rep Lab Science & Architecture",
        "form_lab.info_subtitle": "Formulas, biomechanical ratios, and zero-knowledge storage",
        ...
        "form_lab.info_antagonist_title": "Why Structural Balance Matters",
        "form_lab.info_antagonist_desc": "Significant imbalances between agonist and antagonist muscle groups (such as excessive pushing without pulling, or quad dominance without hamstring posterior chain work) create joint shear forces and forward head / rounded shoulder postures.",
    ...
    public static let tr: [String: String] = [
        ...
        "matrix.info.title": "Hacim ve Toparlanma Rehberi",
        "matrix.info.overviewTitle": "Bu Matris Ne Gösterir?",
        "matrix.info.overviewText": "13 ana kas grubundaki haftalık hacminizi Renaissance Periodization (RP) bilimsel hacim sınırlarını kullanarak takip eder. Aşırı yorgunluk biriktirmeden maksimum kas gelişimine ulaşmanızı sağlar.",
        "matrix.info.calculationTitle": "Hacim Nasıl Hesaplanır?",
        "matrix.info.directSetsTitle": "Doğrudan Setler (1.0×)",
        "matrix.info.directSetsDesc": "Kasın birincil çalıştığı egzersizler tam set sayılır (ör. Göğüs için Bench Press 1.0× settir).",
        "matrix.info.indirectSetsTitle": "Dolaylı Setler (0.5×)",
        "matrix.info.indirectSetsDesc": "Harekete belirgin destek veren ikincil kaslar yarım set sayılır (ör. Bench Press sırasında Arka Kol ve Ön Omuz 0.5× settir).",
        "matrix.info.zonesTitle": "Hacim ve Toparlanma Bölgeleri",
        "matrix.info.zonesSubtitle": "İlerleyici kas gelişimi için bilimsel hacim eşikleri",
        "matrix.info.rangeUnderMev": "< MEV",
        "matrix.info.rangeProgressive": "MEV – MAV",
        "matrix.info.rangeOptimalMav": "MAV Min – Max",
        "matrix.info.rangeHighFatigue": "MAV – MRV",
        "matrix.info.rangeOverMrv": "> MRV",
        "matrix.info.zoneUnderMevDetail": "Minimum Etkili Hacmin altı. Uyarı yalnızca mevcut kası korumaya yeterlidir, yeni kas gelişimi sağlamaz.",
        "matrix.info.zoneProgressiveDetail": "İlerleyici Yükleme Bölgesi. Düşük yorgunluk birikimiyle kas protein sentezini ve düzenli gelişimi başlatır.",
        "matrix.info.zoneOptimalMavDetail": "Maksimum Uyum Hacmi — İdeal Büyüme Bölgesi. Efor başına en yüksek kas büyüme hızını sağlayan en verimli hacim aralığıdır.",
        "matrix.info.zoneHighFatigueDetail": "Yüksek Yorgunluk. Gelişim sağlar ancak sistemik ve eklem yorgunluğunu hızla artırır. Deload öncesi son haftalarda kullanılmalıdır.",
        "matrix.info.zoneOverMrvDetail": "Maksimum Toparlanabilir Hacim Aşıldı. Yorgunluk toparlanma kapasitesini geçer; performans kaybına, sakatlık riskine ve 'çöp hacme' yol açar.",
        "matrix.info.tipTitle": "Antrenman İpucu",
        "matrix.info.tipText": "Antrenman bloğunuz boyunca hedef kasları İlerleme veya Optimal MAV bölgelerinde tutmayı hedefleyin; birden fazla kas Yüksek Yorgunluk veya MRV Üstüne ulaştığında deload haftası planlayın.",
        ...
        "pro.form_lab.description": "Çoklu tekrar maksimum matrisi, boylamsal güç eğrileri, antagonist denge oranları ve şifreli özel bulut aynası.",
        ...
        "form_lab.tab_balance": "Yapısal Denge",
        ...
        "form_lab.balance_title": "Antagonist ve Yapısal Denge",
        "form_lab.balance_subtitle": "Eklem sıkışması ve duruş bozukluklarını önlemek için zıt kas grupları arasındaki biyomekanik oranlar",
        "form_lab.balance.optimal": "OPTİMAL DENGE",
        "form_lab.balance.primary_dominant": "BİRİNCİL AĞIRLIKLI",
        "form_lab.balance.antagonist_dominant": "ANTAGONİST AĞIRLIKLI",
        "form_lab.balance.insufficient_data": "DAHA FAZLA VERİ GEREKLİ",
        "form_lab.balance.push_pull_title": "İtiş vs. Çekiş (Omuz & Skapula)",
        "form_lab.balance.push_label": "İtiş",
        "form_lab.balance.pull_label": "Çekiş",
        "form_lab.balance.push_dominant_alert": "İtiş Baskın: Ön omuz kapsül gerilimi ve içe rotasyon riski artar.",
        "form_lab.balance.pull_dominant_alert": "Çekiş Baskın: Arka üst vücut hacmi baskın.",
        "form_lab.balance.push_pull_optimal": "Dengeli omuz eklem stabilitesi ve kürek kemiği retraksiyonu.",
        "form_lab.balance.push_dominant_rec": "Öneri: Omuzları korumak için Face Pull, Göğüs Destekli Row veya Arka Omuz egzersizleri ekleyin.",
        "form_lab.balance.pull_dominant_rec": "Öneri: Başüstü veya yatay itiş varyasyonlarıyla dengeleyin.",
        "form_lab.balance.push_pull_optimal_rec": "Mükemmel yapısal simetri. Dengeli programlamaya devam edin.",
        "form_lab.balance.quad_ham_title": "Ön Bacak vs. Arka Bacak (Diz & ACL)",
        "form_lab.balance.quad_label": "Ön Bacak (Quad)",
        "form_lab.balance.ham_label": "Arka Bacak (Hamstring)",
        "form_lab.balance.quad_dominant_alert": "Ön Bacak Baskın: Ön diz makaslama kuvveti ve patellofemoral yük artar.",
        "form_lab.balance.ham_dominant_alert": "Arka Bacak Baskın: Yüksek arka zincir eğilimi.",
        "form_lab.balance.quad_ham_optimal": "Dengeli diz fleksiyon ve ekstansiyon tork kuvvetleri.",
        "form_lab.balance.quad_dominant_rec": "Öneri: Romanian Deadlift, Leg Curl veya Hip Thrust ekleyin.",
        "form_lab.balance.ham_dominant_rec": "Öneri: Squat veya Bacak Ekstansiyonu ile dengeleyin.",
        "form_lab.balance.quad_ham_optimal_rec": "Optimal diz fleksiyon-ekstansiyon dengesi.",
        "form_lab.balance.upper_lower_title": "Üst vs. Alt Vücut (Sistemik Dağılım)",
        "form_lab.balance.upper_label": "Üst Vücut",
        "form_lab.balance.lower_label": "Alt Vücut",
        "form_lab.balance.upper_dominant_alert": "Üst Vücut Ağırlıklı: Alt vücut stabilitesi için bacak hacmini artırmayı değerlendirin.",
        "form_lab.balance.lower_dominant_alert": "Alt Vücut Ağırlıklı: Bacak odaklı antrenman dağılımı.",
        "form_lab.balance.upper_lower_optimal": "Tüm vücuda dengeli dağıtılmış antrenman uyarısı.",
        "form_lab.balance.upper_dominant_rec": "Öneri: Haftalık bacak antrenman sıklığını artırın.",
        "form_lab.balance.lower_dominant_rec": "Öneri: Üst vücut bileşik itiş/çekiş setleri ekleyin.",
        "form_lab.balance.upper_lower_optimal_rec": "Sistemik antrenman dağılımınız oldukça orantılı.",
        "form_lab.balance.more_data_needed": "Denge analizini açmak için her iki grupta en az 3 çalışma seti kaydedin.",
        "form_lab.balance.log_more_workouts": "Yapısal oranı hesaplamak için daha fazla antrenman kaydedin.",
        ...
        "form_lab.info_title": "Rep Lab Bilimi ve Mimarisi",
        "form_lab.info_subtitle": "Formüller, biyomekanik oranlar ve sıfır bilgi depolama",
        ...
        "form_lab.info_antagonist_title": "Yapısal Denge Neden Önemlidir?",
        "form_lab.info_antagonist_desc": "Agonist ve antagonist kas grupları arasındaki belirgin dengesizlikler (çekiş yapmadan sürekli itiş yapmak veya arka bacak çalıştırmadan aşırı ön bacak yüklemesi) eklem makaslama kuvvetlerine, öne düşük omuzlara ve postür bozukluklarına yol açar.",
