...
public enum Translations {
    public static let en: [String: String] = [
        ...
        "video.urlInputPlaceholder": "Paste YouTube or web video link",
        "video.addUrlButton": "Add link",
        "video.pasteButton": "Paste",
        ...
        "video.maxLimitReached": "Maximum of 3 video links reached.",
        "video.duplicateUrl": "This video is already linked.",
        "video.invalidUrl": "Enter a valid http:// or https:// video URL.",
        "video.noVideos": "No videos linked to this exercise yet. Add a YouTube or web link below.",
        ...
        "programs.importJson": "Import JSON",
        "programs.apply": "Apply",
        "programs.export": "Export",
        "programs.edit": "Edit",
        "editor.title": "Program editor",
        "editor.details": "Program details",
        "editor.name": "Program name",
        "editor.description": "Description (optional)",
        "editor.schedule": "Weekly schedule",
        "editor.workoutTitle": "Workout title",
        "editor.addExercise": "Add exercise",
        "editor.save": "Save program",
        ...
        "common.done": "Done",
        "editor.videos": "Technique videos",
    ...
    public static let tr: [String: String] = [
        ...
        "video.urlInputPlaceholder": "YouTube veya web video bağlantısı yapıştır",
        "video.addUrlButton": "Bağlantı ekle",
        "video.pasteButton": "Yapıştır",
        "video.previewVideo": "Önizle",
        "video.deleteVideo": "Videoyu sil",
        "video.linkedCount": "Bağlı videolar ({count}/3)",
        "video.tapToPlay": "Oynatmak için dokun",
        "video.maxLimitReached": "En fazla 3 video bağlantısı eklenebilir.",
        "video.duplicateUrl": "Bu video zaten ekli.",
        "video.invalidUrl": "Geçerli bir http:// veya https:// video bağlantısı girin.",
        "video.noVideos": "Bu egzersize henüz video bağlanmadı. Aşağıdan YouTube veya web bağlantısı ekleyin.",
        ...
        "programs.importJson": "JSON içe aktar",
        "programs.apply": "Uygula",
        "programs.export": "Dışa aktar",
        "programs.edit": "Düzenle",
        "editor.title": "Program düzenleyici",
        "editor.details": "Program detayları",
        "editor.name": "Program adı",
        "editor.description": "Açıklama (isteğe bağlı)",
        "editor.schedule": "Haftalık plan",
        "editor.workoutTitle": "Antrenman başlığı",
        "editor.addExercise": "Egzersiz ekle",
        "editor.save": "Programı kaydet",
        "editor.export": "JSON dışa aktar",
